...
import static com.xatkit.RBAC.YoutubeAPI.getSearchListResponse;
import static com.xatkit.RBAC.YoutubeAPI.getService;

import static com.xatkit.dsl.DSL.*;

/**
 * This is an RBAC greetings bot designed with Xatkit.
 * <p>
...
public class GreetingsBot {
    ...
    public static void main(String[] args) {
         ...
         * <p>
         * In this RBAC we want our bot to answer greetings inputs and "how are you" questions, so we create an
         * intent for each, and we give a few RBAC training sentences to configure the underlying NLP engine.
         * <p>
        ...
        val myNameIs = intent("MyNameIs")
                .trainingSentence("Elena")
                .parameter("name").fromFragment("Elena").entity(givenName());
         ...
         * <p>
         * In our RBAC we want to receive intents (i.e. interpreted user inputs) from our react client, so we
        ...
        val awaitingName = state("AwaitingName");
        val handleNamedWelcome = state("HandleNamedWelcome");
        val askFavColour = state("AskFavColour");
        ...
        handleWelcome
                .body(context -> reactPlatform.reply(context, "Hi! What's your name?"))
                .next()
                    /*
        ...
        awaitingName
                .next()
                .when(intentIs(myNameIs)).moveTo(handleNamedWelcome);

        handleNamedWelcome
                .body(context -> reactPlatform.reply(context, "Nice to meet you " + (String) context.getIntent().getValue("name")))
                .next()
                .moveTo(askFavColour);

        askFavColour
                .body(context -> reactPlatform.reply(context, "What's your favourite colour?"))
                .next()
